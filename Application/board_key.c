...
//    Board_KEY_RIGHT     | PIN_GPIO_OUTPUT_DIS  | PIN_INPUT_EN  |  PIN_PULLUP,
	BOARD_KEY1      | PIN_GPIO_OUTPUT_DIS  | PIN_INPUT_EN  |  PIN_NOPULL, //PIN_PULLUP, // SHIRZAD
	BOARD_KEY2     | PIN_GPIO_OUTPUT_DIS  | PIN_INPUT_EN  |  PIN_NOPULL, //PIN_PULLUP, // SHIRZAD
    PIN_TERMINATE
};
...
void Board_initKeys(keysPressedCB_t appKeyCB)
{
  ...
  PIN_setConfig(hKeyPins, PIN_BM_IRQ, BOARD_KEY1  | PIN_IRQ_POSEDGE); // PIN_IRQ_NEGEDGE // SHIRZAD
  PIN_setConfig(hKeyPins, PIN_BM_IRQ, BOARD_KEY2  | PIN_IRQ_POSEDGE); // PIN_IRQ_NEGEDGE // SHIRZAD
...
#ifdef POWER_SAVING
  //Enable wakeup
  PIN_setConfig(hKeyPins, PINCC26XX_BM_WAKEUP, BOARD_KEY1 | PINCC26XX_WAKEUP_POSEDGE); // PINCC26XX_WAKEUP_NEGEDGE // SHIRZAD
  PIN_setConfig(hKeyPins, PINCC26XX_BM_WAKEUP, BOARD_KEY2 | PINCC26XX_WAKEUP_POSEDGE); // PINCC26XX_WAKEUP_NEGEDGE // SHIRZAD
